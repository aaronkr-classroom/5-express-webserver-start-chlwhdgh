 ...
 */
app.get("/item/:item", homeController.sendReqParam); // @TODO: "/items/:item"로의 GET 요청 처리 (p. 153)
app.get("/users/:userID", homeController.sendCourseReqParam); // @TODO: "/users/:userID"로의 GET 요청 처리 (추가)
app.get("/courses/:coursesID", homeController.sendCourseReqParam); // @TODO: "/courses/:courseId"로의 GET 요청 처리 (추가)
